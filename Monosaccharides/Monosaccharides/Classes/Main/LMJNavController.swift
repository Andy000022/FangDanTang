...
class LMJNavController: UINavigationController {
    ...
    override func viewDidLoad() {
        ...
        navBar.tintColor = UIColor.init(hexString: "f75353")
        navBar.titleTextAttributes = [NSForegroundColorAttributeName: UIColor.init(hexString: "f75353"), NSFontAttributeName: UIFont.systemFont(ofSize: 20)]
